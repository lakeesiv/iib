...
\begin{figure}[H]
    \centering
    \subfloat[]{\includegraphics[width=0.8\linewidth]{./fig/saw/tetnp.png}}\\
    \subfloat[]{\includegraphics[width=0.8\linewidth]{./fig/saw/tetnp-2.png}}\\
    \subfloat[]{\includegraphics[width=0.8\linewidth]{./fig/saw/tetnp-3.png}}
